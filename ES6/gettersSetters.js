//very very important
// get to know why 26 was returned after setting the temperature
...
class Thermostat {
  ...
  //usually getters do not have parameters
  get temperature(){
    //this will return the new temperature 78.8 in the forumula then re-calculate it 
    return 5/9 * (this.fahrenheit - 32); //prints 26
  }
  set temperature(ctemp){
    console.log(this.fahrenheit)//returns 76
    this.fahrenheit = ctemp * 9.0 / 5 + 32;//this will calculate the new temperature and take it back to get temperature()
    console.log(this.fahrenheit)//returns 78.8
  }
}
...
//getters and setters functions are not called with ()
