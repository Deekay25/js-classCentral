...
// replace a for loop. Now, let's look at a more complex function that returns 
// an array of consecutive integers starting with 1 through the number passed to the function.
...
// an argument, n, representing the final number. Then it will need to call itself with 
...
// based on the n parameter. If the function is called with a number less than 1, 
// the function should return an empty array. For example, calling this function 
// with n = 5 should return the array [5, 4, 3, 2, 1]. Your function must use recursion 
