...
// with 1 through the number passed to the function.
...
// Then it will need to call itself with progressively smaller values of n until it reaches 
...
// At first, this seems counterintuitive since the value of n decreases, but the values in the final array 
// are increasing. This happens because the push happens last, after the recursive call has returned. 
// At the point where n is pushed into the array, countup(n - 1) has already been evaluated and 
// returned [1, 2, ..., n - 1].

// We have defined a function called countdown with one parameter (n). 
// The function should use recursion to return an array containing the integers n through 1 based 
...
// the array [5, 4, 3, 2, 1]. Your function must use recursion by calling itself and must not use loops 
// of any kind.
